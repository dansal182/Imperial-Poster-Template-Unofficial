...
Poster Session \hfill
  \href{mailto:someone@imperial.ac.uk}{email@imperial.ac.uk}}
...
% Left: institution
 \logoleft{\includegraphics[height=7cm]{logos/Imperial_Logo.png}}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{References}
    ...
    \footnotesize{\bibliographystyle{aasjournal}\bibliography{references}}
